        ...
        jQuery('#' + elementId).fileupload({
            ...
            .on(
                ...
                function (e, data) {
                    ...
                    jQuery('#from-text-fileuploader-progress .bar')
                        .css('width', progress + '%');
            ...
            }).prop('disabled', !jQuery.support.fileInput).parent()
                ...
                _opener.bind(_event, function () {
                    if (!_slider.is(':animated')) {
                        if (typeof _animStart === 'function')
                            _animStart();
                        if (_holder.hasClass(_activeClass) && !closeBtn.length) {
        ...
        recalcOffsets: function (curr) {
            if (this.options.vertical) {
                ...
                if (this.options.step) {
                    ...
                    this.stepCount = Math
                        .ceil((this.sumHeight - this.sliderHolder.height()) / this.stepHeight) + 1;
                ...
                if (this.options.step) {
                    ...
                    this.stepCount = Math
                        .ceil((this.sumWidth - this.sliderHolder.width()) / this.stepWidth) + 1;
...
function VSA_createScrollBar() {
    ...
    if (this.enableScrollbar) {
        ...
        this.subscrollslider.style.height = Math
            .round((this.scrollContent.offsetHeight / this.scrollContent.scrollHeight) * (this.scrollbar.offsetHeight - 2 * this.scrollButtonHeight)) + "px";
    ...
    PlaceholderInput.prototype = {
        ...
        setOptions: function (opt) {
            ...
            if (this.options.element) {
                ...
                this
                    .setOrigValue(this.options.placeholderAttr == 'value' ? this.element.defaultValue : this.element
