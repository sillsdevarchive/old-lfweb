 ...
 * </p>
 */
public class ExtendedCheckBox extends ButtonBase implements HasName,
	...
	DivElement inputElem;
	LabelElement labelElem;
	private LeafValueEditor<Boolean> editor;
	private boolean valueChangeHandlerInitialized;
	private String objName = "";
	private Boolean objChecked = false;
	private boolean objDisabled = false;
	 ...
	 *            element.
	 */
	public ExtendedCheckBox(SafeHtml label, Direction dir) {
		this();
		setHTML(label, dir);
	}
	 ...
	 *            {@link #DEFAULT_DIRECTION_ESTIMATOR} can be used.
	 */
	public ExtendedCheckBox(String label, DirectionEstimator directionEstimator) {
		this();
		setDirectionEstimator(directionEstimator);
		setText(label);
	}
	...
	protected ExtendedCheckBox(Element elem) {
		super(DOM.createSpan());

		inputElem = Document.get().createDivElement();
		labelElem = Document.get().createLabelElement();
		Event.sinkEvents(inputElem,Event.ONCLICK);
		inputElem.setClassName("ext_checkboxArea"); // default is not checked
	...
	public void setValue(Boolean value, boolean fireEvents) {
		...
		{
			inputElem.setClassName("ext_checkboxAreaChecked"); 
			labelElem.setClassName("ext_checkboxAreaCheckedLabel");
		}else
		{
			inputElem.setClassName("ext_checkboxArea"); 
			labelElem.setClassName("ext_checkboxAreaLabel");
		}
	...
	public void onBrowserEvent(Event event) {
        ...
        case Event.ONCLICK:
			...
			ValueChangeEvent.fire(ExtendedCheckBox.this, getValue());
        } 
