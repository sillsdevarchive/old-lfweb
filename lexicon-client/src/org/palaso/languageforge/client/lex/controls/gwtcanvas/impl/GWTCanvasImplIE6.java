...
import org.palaso.languageforge.client.lex.controls.gwtcanvas.JSOStack;
...
public class GWTCanvasImplIE6 implements GWTCanvasImpl {
  ...
  private native void insert(String gco, String html) /*-{
    this.@org.palaso.languageforge.client.lex.controls.gwtcanvas.impl.GWTCanvasImplIE6::shapeContainer.insertAdjacentHTML(gco, html);
  }-*/;
}
