	...
	SliderNV.prototype = {
		...
		swichFunction: function(curr){
			if(!this.slides.eq(curr).length){
				if(this.prevElement == 0) this.currentElement = this.slides.length-1; else if(this.prevElement == this.slides.length-1) this.currentElement = 0;
				this.prevElement = this.currentElement;
			}
			if(!this.options.effect){
				...
				this.slides.eq(this.currentElement).stop(false, true).fadeIn(this.options.animSpeed, jQuery.proxy(function(){
