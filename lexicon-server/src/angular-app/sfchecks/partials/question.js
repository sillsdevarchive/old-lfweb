...
angular.module(
		'sfchecks.question',
		[ 'lf.services', 'palaso.ui.listview', 'palaso.ui.jqte', 'ui.bootstrap', 'palaso.ui.selection', 'palaso.ui.notice' ]
	)
	.controller('QuestionCtrl', ['$scope', '$routeParams', 'questionService', 'sessionService', 'breadcrumbService', 'silNoticeService',
		...
		var questionRefKey = $routeParams.entryRefKey;
		...
		questionService.read(projectId, entryId, questionRefKey, function(result) {
			console.log('questionService.read(', projectId, entryId, questionRefKey, ')');
			if (result.ok) {
